...
class TaskA2 {
    ...
    public static void main(String[] args) {
        ...
        String intro = "Мое любимое стихотворение:";

        String a = "Hello world, hello world, world hello!";
        String b = "Hello world, hello world, world hello!!";
        String c = "Hello world, hello world, world hello!!!";
        String d = "Hello world, hello world, world hello!!!!";
        String e = "Hello world, hello world, world hello!!!!!";
        String f = "Hello world, hello world, world hello!!!!!!";
        String g = "Hello world, hello world, world hello!!!!!!!";
