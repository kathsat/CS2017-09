...
public class TaskC1 {
    public static void main(String[] args) {
        ...
        long c=1L, d=2L;
        do {
           //System.out.println("Введите положительное число n с клавиатуры (допускаются числа от 0 до 62): ");
            Scanner sc = new Scanner(System.in);
            a = sc.nextInt();
        }
        while (a<0 || a>62);
        String b=Long.toBinaryString(c);
        b = String.format("%"+(a+1)+"s", b).replace(" ", "0");
        System.out.println(b+" = "+c);
        for (int i=0; i<a;i++) {
                c=(d<<i);
                b=Long.toBinaryString(c);
                b = String.format("%"+(a+1)+"s", b).replace(" ", "0");
                System.out.println(b+" = "+c);
        }
    }
