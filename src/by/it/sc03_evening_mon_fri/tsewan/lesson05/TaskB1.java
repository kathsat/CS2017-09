...
public class TaskB1 {
    public static void main(String[] args) {
        ...
        int i = sc.nextInt();
        if (i % 4 == 0) {
            if (i % 400 == 0) System.out.println("количество дней в году: 366");
            else {
                if (i%100==0) System.out.println("количество дней в году: 365");
                else System.out.println("количество дней в году: 366");
            }
        }
        if (i%4!=0) System.out.println("количество дней в году: 365");
    }
}
