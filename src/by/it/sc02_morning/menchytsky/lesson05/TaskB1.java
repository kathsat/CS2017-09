...
public class TaskB1 {
    public static void main(String[] args) {
        ...
        if((i % 4) == 0  && (i%100)!=0) System.out.println("количество дней в году: 366");
        else if(i == 0) System.out.println("количество дней в году: 366");
        else if ((i % 400) == 0 && (i%100)==0) System.out.println("количество дней в году: 366");
