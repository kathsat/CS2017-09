...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Как дымный столп светлеет в вышине! —\n",
                b = "Как тень внизу скользит, неуловима!..\n",
                c = "«Вот наша жизнь, — промолвила ты мне, —\n",
                d = "Не светлый дым, блестящий при луне,\n",
                e = "А эта тень, бегущая от дыма…»";
