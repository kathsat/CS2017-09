...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String a = "Все важные фразы должны быть тихими,";
        String b = "Все фото с родными всегда нерезкие,";
        String c = "Самые странные люди всегда великие,";
        String d = "А причина для счастья всегда невезкое.";
