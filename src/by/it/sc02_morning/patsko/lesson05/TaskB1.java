...
public class TaskB1 {
    public static void main(String[] args) {
        ...
        int year=sc.nextInt();
        if((year%400==0)||(year%4==0&&year%100!=0)) System.out.println("количество дней в году: 366");
            //если год кратен 400 ИЛИ год кратен 4 И ПРИ ЭТОМ не кратен 100, то год високосный
