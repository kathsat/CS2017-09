...
class TaskA2 {
    ...
    public static void main(String[] args) {
        String a = ("Если вы еще не твердо В жизни выбрали дорогу");
        String b = ("И не знаете, с чего бы Трудовой свой путь начать,");
        String c = ("Бейте лампочки в подъездах Люди скажут вам \"спасибо\".");
        String d = ("Вы поможете народу ");
        String e = "Электричество беречь.";
