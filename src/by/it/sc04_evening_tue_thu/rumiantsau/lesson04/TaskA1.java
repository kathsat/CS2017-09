...
class TaskA1 {
    public static void main(String[] args){
        ...
        double dSm   = (double) x + y;
        double dDiff = (double) x - y;
        double dMul  = (double) x * y;
        double dDiv  = (double) x / y;
        double dRem  = (double) x % y;

        System.out.println(iSm + " " + iDiff + " " + iMul + " " + iDiv + " " + iRem);
        System.out.println(dSm + " " + dDiff + " " + dMul + " " + dDiv + " " + dRem);
    }
}
