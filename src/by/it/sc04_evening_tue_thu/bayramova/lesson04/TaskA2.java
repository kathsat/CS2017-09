...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String a = "I'm the one, Don't weigh  a ton ";
        String b = "Don't need a gun to get respect up on the street";
        String c = "Under the sun, the bastard son";
        String d = "Will pop the glock to feet himself and family.";
