...
class TaskA1 {
    public static void main(String[] args) {
        ...
        int cha = i/l;
        int ost = i%l;
        System.out.println(sum+" "+dif+" "+pro+" "+cha+" "+ost);
        double summ = (double) sum;
        double diff = (double) dif;
        double proi = (double) pro;
        double chas = (double) i/(double)l;
        double osta = (double) ost;
        System.out.println(summ+" "+diff+" "+proi+" "+chas+" "+osta);
