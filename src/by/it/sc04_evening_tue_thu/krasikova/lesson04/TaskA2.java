...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String b="Дзе мой край? Там, дзе вечную песню пяе Белавежа,\n";
        String c="Там, дзе Неман на захадзе помнiць варожую кроу,\n";
        String d="Дзе на узвышшах наваградскiх дрэмлюць суровыя вежы\n";
        String e="I вiшневыя хаты глядзяцца у шырокi Дняпро.";
