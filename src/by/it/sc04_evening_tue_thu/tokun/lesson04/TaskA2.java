...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Украдкой время с тонким мастерством\n";
        String b ="Волшебный праздник создает для глаз.\n";
        String c ="И то же время в беге круговом\n";
        String d ="Уносит все, что радовало нас.\n";
